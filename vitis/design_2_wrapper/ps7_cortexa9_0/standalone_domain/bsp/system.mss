...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = BiDirChannels
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = BiDirChannels_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.13
 PARAMETER HW_INSTANCE = DMA_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = LOOP1_axis_switch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = LOOP1_axis_switch_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = LOOP2_axis_switch_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = LOOP2_axis_switch_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_stream_fifo
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = RX_BUFFER_RxFIFO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = SPI_SPI_ip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_stream_txfifo
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = TX_BUFFER_TxFIFO
END
