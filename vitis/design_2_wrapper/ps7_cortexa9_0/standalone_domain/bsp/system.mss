...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = RxFIFO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = SPI_ip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_stream_txfifo
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = TxFIFO
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = axis_switch_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = axis_switch_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = axis_switch_3
END
