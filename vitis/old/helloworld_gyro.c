...
//    xil_printf("Loop1 active\r\n");

    //Deactivate LOOP 1  (NORMAL MODE)
    ///////////////////////////////////////////////
	// AXI Stream Switches  1& 2   				 //
	///////////////////////////////////////////////
    ...
    XAxiDma_WriteReg(0x43C50000,0x00000000,0x00000002);  // Activate
    xil_printf("Loop1 deactivated(normal mode)\r\n");
    //==============================
    ...
    xil_printf("Loop2 active\r\n");

    //Deactivate LOOP 2  (NORMAL MODE)
	//////////////////////////////////////////////
	// AXI Stream Switches  3& 4                //
	//////////////////////////////////////////////
...
//    XAxiDma_WriteReg(0x43C70000,0x00000000,0x00000002);  // Activate
//    xil_printf("Loop2 deactivated(normal mode)\r\n");
    //==============================
    ...
    // To Fill Only                            // 
    /////////////////////////////////////////////   
    XAxiDma_WriteReg(0x43C30000,0x00000000,0x00000001);  // Enable the PUSH in RX
