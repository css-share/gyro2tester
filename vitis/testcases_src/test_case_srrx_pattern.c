...
int main(){
    ...
    xil_printf("Testing Test Case with SR RX Pattern of the DMA RX \r\n");
    xil_printf("---------------------------------------------------\r\n");
    xil_printf("---------------------------------------------------\r\n");
    ///////////////////////////////////////////////
    ...
    XAxi_WriteReg(S2MM_LENGTH, MAX_PKT_LEN);
     ...
     xil_printf("Enable Bidir serial no loopback with rx pattern\r\n");
     XAxi_WriteReg(BIDIR_REG0, 0x20000000);
    ...
    print("Results of test_case_srrx_pattern \n\r");
