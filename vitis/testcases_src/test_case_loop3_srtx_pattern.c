...
int main(){
    ...
    xil_printf("Testing Test Case Loop 3 with TXSR Pattern of the DMA TX/RX \r\n");
    xil_printf("---------------------------------------------------\r\n");
    xil_printf("---------------------------------------------------\r\n");
    ///////////////////////////////////////////////
    ...
    XAxi_WriteReg(S2MM_LENGTH, MAX_PKT_LEN);
     ...
     XAxi_WriteReg(BIDIR_REG0, 0x41000000);
    ...
    print("Results of test_case_loop3_srtx_pattern \n\r");
