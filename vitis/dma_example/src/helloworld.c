...
int main(){
    ...
    XAxiDma_WriteReg(0x43C00000,0x00000040,0x00000000);
    XAxiDma_WriteReg(0x43C00000,0x00000000,0x00000002);
    XAxiDma_WriteReg(0x43C50000,0x00000040,0x00000000);
    XAxiDma_WriteReg(0x43C50000,0x00000044,0x80000000);
    XAxiDma_WriteReg(0x43C50000,0x00000000,0x00000002);
...
//	WR 0x43C5_0044 8000_0000   // SW1 deactivate M1
