...
int main(){
    ...
    xil_printf("\r\n---------------------------------------------------\r\n");
    xil_printf("---------------------------------------------------\r\n");
    xil_printf("Testing Normal Mode Operation of the TX/RX DMA \r\n");
...
*/
    ...
    ///////////////////////////////////////////////
    // AXI Stream Switches in 'NORMAL' Mode      //
    ///////////////////////////////////////////////
    ...
    xil_printf("Tx Fifo Fill Levels %x \r\n", XAxi_ReadReg(TXFIFO_REG3));
	...
	while(Buffer_Not_Full(TXFIFO_REG3)){
	 ...
	 xil_printf("Rx Fifo Fill Levels %x \r\n", XAxi_ReadReg(RXFIFO_REG3));


     xil_printf("Setup Bidir block \r\n");
     XAxi_WriteReg(BIDIR_REG0, 0x00000000);
     XAxi_WriteReg(BIDIR_REG2, 0x00000001);		// bit 0 enables BiDir block
     XAxi_WriteReg(BIDIR_REG1, 0x00000011);		// bit 0 enables Tx, bit 4 enables Rx
...
//		 }
    ...
    print("Results of test_case_loop3_asic.c \r\n");
