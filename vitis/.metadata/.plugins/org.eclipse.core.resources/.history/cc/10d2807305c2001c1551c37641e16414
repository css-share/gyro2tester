...
int main(){
    ...
    XAxiDma_WriteReg(0x43C60000,0x00000040,0x80000000);  // SW1 connect M0 to S0
    XAxiDma_WriteReg(0x43C60000,0x00000044,0x00000000);  // SW1 deactivate M1
    XAxiDma_WriteReg(0x43C60000,0x00000000,0x00000002);  // Activate

    XAxiDma_WriteReg(0x43C70000,0x00000040,0x00000001);  // SW0 connect M0 to S0
    ...
    XAxiDma_WriteReg(0x43C40000,0x00000000,0x00010001);  // Enable the TXFIFO
    ...
    /////////////////////////////////////////////   
    XAxiDma_WriteReg(0x43C30000,0x00000000,0x00000001);  // Enable the PUSH in RX TEST PATTERN
  ...
  //   XAxiDma_WriteReg(0x43C20000,0x00000000,0x01000000);  // bit6:Enable BiDir,bit4:clkDiv
