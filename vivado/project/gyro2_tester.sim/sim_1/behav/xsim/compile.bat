...
REM
REM Generated by Vivado on Thu May 12 21:07:01 -0700 2022
...
call xvlog  --incr --relax -L uvm -L axi_vip_v1_1_11 -L processing_system7_vip_v1_0_13 -L smartconnect_v1_0 -L xilinx_vip -prj tb_vlog.prj -log xvlog.log
