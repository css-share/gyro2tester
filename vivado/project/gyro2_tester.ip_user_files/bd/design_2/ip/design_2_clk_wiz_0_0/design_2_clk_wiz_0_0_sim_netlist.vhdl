...
-- Date        : Thu Apr 14 22:14:57 2022
-- Host        : AsusP8 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Xilinx_projects/gyro2tester/vivado/project/gyro2_tester.gen/sources_1/bd/design_2/ip/design_2_clk_wiz_0_0/design_2_clk_wiz_0_0_sim_netlist.vhdl
...
entity design_2_clk_wiz_0_0_clk_wiz is
  port (
...
end design_2_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of design_2_clk_wiz_0_0_clk_wiz is
  signal clk_in1_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_design_2_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out2_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_design_2_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out3_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_design_2_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out4_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_design_2_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out5_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out5_design_2_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clkfbout_buf_design_2_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_design_2_clk_wiz_0_0 : STD_LOGIC;
  ...
  attribute XILINX_TRANSFORM_PINMAP of clkout5_buf : label is "CE:CE0 I:I0 GND:S1,IGNORE0,CE1 VCC:S0,IGNORE1,I1";
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_design_2_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out1_design_2_clk_wiz_0_0_en_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_out2_design_2_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out2,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out2_design_2_clk_wiz_0_0_en_clk
    );
clkout3_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg3(7),
      CE1 => '0',
      I0 => clk_out3_design_2_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out3,
...
clkout3_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out3_design_2_clk_wiz_0_0,
      O => clk_out3_design_2_clk_wiz_0_0_en_clk
    );
clkout4_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg4(7),
      CE1 => '0',
      I0 => clk_out4_design_2_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out4,
...
clkout4_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out4_design_2_clk_wiz_0_0,
      O => clk_out4_design_2_clk_wiz_0_0_en_clk
    );
clkout5_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg5(7),
      CE1 => '0',
      I0 => clk_out5_design_2_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out5,
...
clkout5_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out5_design_2_clk_wiz_0_0,
      O => clk_out5_design_2_clk_wiz_0_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT2 => clk_out3_design_2_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcm_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_design_2_clk_wiz_0_0,
      CLKOUT3B => NLW_mmcm_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_out5_design_2_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_design_2_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_design_2_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg2(0)
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out3_design_2_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg3(0)
...
\seq_reg4_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out4_design_2_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg4(0)
...
\seq_reg5_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out5_design_2_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg5(0)
...
entity design_2_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of design_2_clk_wiz_0_0 : entity is true;
end design_2_clk_wiz_0_0;

architecture STRUCTURE of design_2_clk_wiz_0_0 is
begin
inst: entity work.design_2_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
