...
HD_PWD='/home/cdickins/reuse/gyro2tester-main_v2/vivado/project/gyro2_tester.runs/design_2_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_smartconnect_0_0.tcl
