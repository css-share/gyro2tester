...
HD_PWD='/home/cdickins/reuse/gyro2tester-main/vivado/project/gyro2_tester.runs/design_2_axis_switch_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axis_switch_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axis_switch_2_0.tcl
