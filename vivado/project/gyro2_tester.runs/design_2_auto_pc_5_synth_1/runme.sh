...
HD_PWD='C:/Xilinx_projects/gyro2tester/vivado/project/gyro2_tester.runs/design_2_auto_pc_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_auto_pc_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_auto_pc_5.tcl
