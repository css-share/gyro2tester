...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_2_util_ds_buf_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_util_ds_buf is
  ...
  attribute C_BUF_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_util_ds_buf : entity is "IOBUFDS";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_util_ds_buf is
  ...
  attribute box_type of \USE_IOBUFDS.GEN_IOBUFDS[0].IOBUFDS_I\ : label is "PRIMITIVE";
begin
  BUFGCE_O(0) <= \<const0>\;
...
\USE_IOBUFDS.GEN_IOBUFDS[0].IOBUFDS_I\: unisim.vcomponents.IOBUFDS
    generic map(
      IOSTANDARD => "DEFAULT"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_2_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "util_ds_buf,Vivado 2021.2";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of U0 : label is "IOBUFDS";
  attribute C_MODE : string;
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_util_ds_buf
     port map (
      ...
      IOBUF_DS_N(0) => IOBUF_DS_N(0),
      IOBUF_DS_P(0) => IOBUF_DS_P(0),
