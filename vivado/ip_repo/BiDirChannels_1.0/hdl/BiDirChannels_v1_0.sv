...
//////////////////////////////////////////////////////////////
	...
	(
    	...
    	parameter integer C_M00_AXIS_START_COUNT    = 4
	)
	(        
        input  wire DRX,
        input clk,
  ...
  // ------------------------------------------
    ...
    GyroInputOutputSerializer u_gyro_serialout(
      ...
      .rx_sample_cfg  (data_word_2[31:24]),
      .rx_skew_en     (data_word_2[20]),			 
